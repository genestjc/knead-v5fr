...
// ✅ Use Alchemy RPC for ThirdWeb/blockchain operations (NFT checks, balances, etc.)
export const activeChain = {
  ...base,
  rpc: baseRpcUrl, // Your Alchemy RPC
};

// ✅ NEW: Use public Base RPC for Towns Protocol
// Towns needs standard Base RPC (not Alchemy) due to custom routing/headers
export const townsChainRpc = 'https://mainnet.base.org';

logger.log(`ThirdWeb client initialized (${typeof window === 'undefined' ? 'server' : 'client'} side)`);
logger.log(`Using Alchemy RPC for blockchain ops, public RPC for Towns`);
