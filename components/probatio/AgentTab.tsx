        ...
        <div className="px-6 py-5 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              >
                {/* The AEO surfaces grade websites, not conversations — they
                    have no persona to drive and live in their own tab. */}
                {EVAL_SURFACES.filter((s) => !s.id.startsWith('aeo-')).map((s) => (
