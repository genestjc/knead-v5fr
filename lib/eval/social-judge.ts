...
// The pure half — shapes, the four dimensions, the post ids. Kept in its own
// module so a client component can import a value from it without dragging two
// provider SDKs into the browser bundle. Re-exported so callers need not care.
