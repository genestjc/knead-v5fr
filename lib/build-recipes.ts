...
export const RECIPES: BuildRecipe[] = [
  ...
  },
  {
    ...
    emoji: '🤖',
    description: 'Install an agent on your page for community management or to help summarize editorial content. Built with ChatGPT, Claude, AgentCard, and Tavily.',
    ...
    stack: ['Next.js 14', 'Anthropic Claude Opus + Sonnet', 'OpenAI GPT-5.6', 'Tavily', 'AgentCard'],
