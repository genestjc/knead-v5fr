...
export const RECIPES: BuildRecipe[] = [
  ...
  },
  {
    ...
    architectureNote: 'Each DM thread is a Towns space created on demand. Video calls within DMs use Daily.co rooms created server-side and destroyed after the call ends.',
    ...
    customizationNotes: 'DM room creation logic is in app/api/dm/. Video call integration follows the same pattern as the streaming module.',
    canonicalFiles: [
