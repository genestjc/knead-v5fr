...
import { uploadToIPFS } from '@/lib/thirdweb/storage'; // ✅ ADD THIS
import { Paperclip } from 'lucide-react'; // ✅ ADD THIS
      ...
      <DailyProvider>
        <ChatLayout>
          {activeEvent && activeEvent.videoEnabled && dailyToken && activeEvent.dailyRoomUrl ? (
            // SPLIT-SCREEN LAYOUT (keep all your existing video layout code)
            <>
