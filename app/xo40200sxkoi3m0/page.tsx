    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="proposal">
        ...
        <p className="p-body font-georgia-pro">
          Knead is a media and community platform built entirely on Base. We believe the future of
          the internet is about owning your hub for streaming, community, and content. To help
          Base&apos;s mission of bringing the world on-chain, Knead wants to partner on a business
        ...
        <p className="p-body font-georgia-pro">
          Base pays Knead to reach out to creators and say: &ldquo;We&apos;ll build you a custom
          platform for streaming, writing, music, and more — for free. Base is covering the bill as
          long as it includes one Base product or solution.&rdquo;
        </p>
        <p className="p-body font-georgia-pro">
          This would especially include working on solutions from our wheelhouse outside Web3 —
          fashion, music, art, food, and other creative endeavors. Think of this similar to a
          &lsquo;Forward Deployed Engineer&rsquo; for creator solutions: replacing a writer&apos;s
          Substack with a custom Base smart contract, ThirdWeb social login, and paywall; or a
          podcaster who wants to move away from Patreon.
        </p>
        <p className="p-body font-georgia-pro">
          Once the creator&apos;s solution is 80–90% complete, Knead works with Base&apos;s
        ...
        <div className="p-grid-4">
          ...
          <div className="p-cell">
            ...
            <div className="p-cell-value font-adonis">$75,000</div>
        ...
        {/* ── Monthly split ── */}
        <p className="p-label font-adonis">Monthly Retainer Split</p>
        ...
        <div className="p-quota">
          <p className="p-quota-title font-adonis">1 Outside Creative Hired Per Month</p>
          <p className="p-quota-body font-georgia-pro">
        ...
        <div className="p-quota">
          ...
          <p className="p-quota-body font-georgia-pro">
            ...
            Base. This means a meeting discussing a bespoke solution is on the books — ideally with
            a rough idea of execution (e.g. this musician wants a listening party; this author wants
            a custom paywalled blog).
          </p>
        </div>
        ...
        <div className="p-quota">
          ...
          <p className="p-quota-body font-georgia-pro">
            ...
            and sent it to the Base team for review by the end of month three.
          </p>
        </div>

        <div className="p-quota">
          <p className="p-quota-title font-adonis">80–90% Complete With 5 Creators by Month 6</p>
          <p className="p-quota-body font-georgia-pro">
            At a minimum, this engagement must bring in five creators with custom solutions within
        ...
        <table className="p-table">
          ...
          <tbody>
            <tr>
              <td className="font-adonis">Every 25 Creators Onboarded</td>
              <td className="font-georgia-pro">Cumulative verified onboarded creators across the engagement.</td>
              <td className="font-adonis">$10,000</td>
            </tr>
            <tr>
              <td className="font-adonis">Every 10 Creators on Base App</td>
              <td className="font-georgia-pro">Creators with an active Base app deployment, verified onchain.</td>
              <td className="font-adonis">$3,500</td>
            </tr>
            <tr>
              <td className="font-adonis">2+ Base Products in a Solution</td>
              <td className="font-georgia-pro">e.g. Base smart contract + ThirdWeb. Minimum 10 verified onchain transactions each.</td>
              <td className="font-adonis">$2,000</td>
            </tr>
            <tr>
              <td className="font-adonis">3+ Base Products in a Solution</td>
              <td className="font-georgia-pro">e.g. Base smart contract + ThirdWeb + Alchemy. Minimum 100 unique users across deployments.</td>
              <td className="font-adonis">$5,000</td>
            </tr>
          </tbody>
        </table>

        <p className="p-heading font-adonis">Audience Size</p>
        <table className="p-table">
          <thead>
            <tr>
              <th className="font-adonis">Platform + Threshold</th>
              <th className="font-adonis">Notes</th>
              <th className="font-adonis" style={{textAlign: 'right'}}>Bonus</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="font-adonis">Substack 1,000+</td>
              <td className="font-georgia-pro">Verified subscriber count at time of onboarding.</td>
              <td className="font-adonis">$2,500</td>
            </tr>
            <tr>
              <td className="font-adonis">Substack 10,000+</td>
              <td className="font-georgia-pro">Verified subscriber count at time of onboarding.</td>
              <td className="font-adonis">$7,500</td>
            </tr>
            <tr>
              <td className="font-adonis">Instagram 10,000+</td>
              <td className="font-georgia-pro">Verified follower count at time of onboarding.</td>
              <td className="font-adonis">$500</td>
            </tr>
            <tr>
              <td className="font-adonis">Instagram 100,000+</td>
              <td className="font-georgia-pro">Verified follower count at time of onboarding.</td>
              <td className="font-adonis">$5,000</td>
            </tr>
            <tr>
              <td className="font-adonis">Instagram 1,000,000+</td>
              <td className="font-georgia-pro">Verified follower count at time of onboarding.</td>
              <td className="font-adonis">$10,000</td>
            </tr>
            <tr>
              <td className="font-adonis">Patreon 1,000+</td>
              <td className="font-georgia-pro">Verified patron count at time of onboarding.</td>
              <td className="font-adonis">$2,500</td>
            </tr>
            <tr>
              <td className="font-adonis">Patreon 10,000+</td>
              <td className="font-georgia-pro">Verified patron count at time of onboarding.</td>
              <td className="font-adonis">$7,500</td>
            </tr>
            <tr>
              <td className="font-adonis">Patreon 100,000+</td>
              <td className="font-georgia-pro">Verified patron count at time of onboarding.</td>
              <td className="font-adonis">$10,000</td>
            </tr>
          </tbody>
        ...
        <p className="p-body font-georgia-pro">
          The future of ownership is also going to come with knowing how to build solutions
          yourself. With Base, people are given a scalable solution that is fast, efficient, and
          doesn&apos;t rely as much on database vulnerabilities. It&apos;s just a matter of getting
          out there and showing people what this future could look like — starting with one creator
          at a time.
        </p>
