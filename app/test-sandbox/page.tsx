  ...
  useEffect(() => {
    ...
    const checkNFTs = async () => {
      try {
        ...
        const freemiumBalance = await contract.read("balanceOf", [
          account.address,
          KNEAD_MEMBERSHIP_CONTRACT.tokenIds.freemium,
        ])
        const premiumBalance = await contract.read("balanceOf", [
          account.address,
          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your current NFT ownership on Base chain (using ABI)</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Test the paywall component with your current membership status</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <UnlockContent storySlug="test-sandbox-story">
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                      ...
                      <p className="text-green-700">
                        Congratulations! Your membership NFT has been verified and you have access to this content.
                      </p>
                      <div className="mt-4 p-4 bg-white rounded border text-left">
                        <h4 className="font-medium mb-2">Sample Premium Content:</h4>
                        <p className="text-sm text-slate-600 mb-2">
                          This is what a premium article would look like. Only users with valid membership NFTs can see
                          this content.
                        </p>
                        <p className="text-sm text-slate-600">
                          Your paywall is working correctly! The UnlockContent component successfully verified your NFT
                          ownership and granted access to this protected content.
                        </p>
                      </div>
                    </div>
                  </UnlockContent>
                ...
                <p className="text-sm text-slate-500 mt-2">
                  The content above is wrapped in the UnlockContent component. If you see the green success message,
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2">Using custom Knead Membership ABI</span>
                  </div>
                </div>
              </CardContent>
            </Card>
